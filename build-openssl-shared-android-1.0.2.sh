...
then
    echo "Usage:"
    echo "./build-openssl-shared-android-1.0.2.sh <ANDROID_NDK_PATH> <OPENSSL_SOURCES_PATH> <ANDROID_TARGET_API> \\"
    ...
    echo "./build-openssl-shared-android-1.0.2.sh /home/user/android-ndk-r10e \\"
...
then
    ...
    #export ANDROID_NDK="/home/mkm/CloudDrive/AndroidToolchain/android-ndk-r17c"
    ...
    ./Configure android-armv7 shared --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android shared --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-x86 shared --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure linux-x86_64 shared --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-mips shared --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-mips64 shared --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
